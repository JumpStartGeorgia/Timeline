...
set :application, "TSU16-Timeline-Staging" # unique name of application
set :user, "tsu-16-staging" # name of user on server
...
set :git_branch_name, "tsu-16" # name of branch to deploy
