...
set :application, "Timeline-Staging" # unique name of application
set :user, "timeline-staging" # name of user on server
...
set :github_repo_name, "Election-Timeline" # name of git hub repo
set :git_branch_name, "feradi" # name of branch to deploy
