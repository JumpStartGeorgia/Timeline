...
##### SET THESE VARIABLES ########
##################################
AS_USER=gudiashvili-staging # name of user on server
APP_ROOT=/home/gudiashvili-staging/Gudiashvili-Timeline-Staging/current # path to application current folder
